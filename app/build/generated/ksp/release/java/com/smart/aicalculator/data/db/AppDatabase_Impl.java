...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `calculation_history` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `expression` TEXT NOT NULL, `result` TEXT NOT NULL, `timestamp` INTEGER NOT NULL, `source` TEXT NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'b4540a4aa63d64fbe9d7307a30f0408e')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsCalculationHistory = new HashMap<String, TableInfo.Column>(5);
        ...
        _columnsCalculationHistory.put("source", new TableInfo.Column("source", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoCalculationHistory.equals(_existingCalculationHistory)) {
          return new RoomOpenHelper.ValidationResult(false, "calculation_history(com.smart.aicalculator.data.db.HistoryEntity).\n"
                  + " Expected:\n" + _infoCalculationHistory + "\n"
                  + " Found:\n" + _existingCalculationHistory);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "b4540a4aa63d64fbe9d7307a30f0408e", "41862fb30bb7f0586f2dfddf37ecb5b5");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "calculation_history");
  }
